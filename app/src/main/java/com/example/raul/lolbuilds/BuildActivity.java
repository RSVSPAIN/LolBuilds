...
public class BuildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (champId == 0)
        {
            ...
            imageView37.setImageResource(R.drawable.ic_piel_de_hierro);
            imageView38.setImageResource(R.drawable.ic_sobrecrecimiento_round);
            ...
            imageView43.setImageResource(R.drawable.ic_condicionamiento_round);
            imageView44.setImageResource(R.drawable.ic_fuentes_renovadas);
        ...
        if (champId == 2)
        {
            ...
            imageView7.setImageResource(R.drawable.ic_rabadon);
            imageView8.setImageResource(R.drawable.ic_teleport);
            ...
            imageView37.setImageResource(R.drawable.ic_botas_gratis_round);
            imageView38.setImageResource(R.drawable.ic_perspicacia_cosmica);
            imageView39.setImageResource(R.drawable.ic_entrega_de_galletas);
            imageView40.setImageResource(R.drawable.ic_mercado_del_futuro);
            ...
            imageView43.setImageResource(R.drawable.ic_desmaterializador);
        ...
        if (champId == 3)
        {
            ...
            imageView2.setImageResource(R.drawable.ic_vestigio_del_aspecto);
            imageView3.setImageResource(R.drawable.ic_botas_movilidad);
            ...
            imageView36.setImageResource(R.drawable.ic_destello_hextech_round);
            imageView37.setImageResource(R.drawable.ic_botas_gratis);
            imageView38.setImageResource(R.drawable.ic_perspicacia_cosmica);
            imageView39.setImageResource(R.drawable.ic_entrega_de_galletas);
            imageView40.setImageResource(R.drawable.ic_mercado_del_futuro_round);
            imageView41.setImageResource(R.drawable.ic_velocidad_de_acercamiento);
        ...
        if (champId == 4)
        {
            ...
            imageView3.setImageResource(R.drawable.ic_tabi_ninja);
            imageView4.setImageResource(R.drawable.ic_tormento_de_liandry);
            imageView5.setImageResource(R.drawable.ic_mascara_abisal);
        ...
        if (champId == 5)
        {
            ...
            imageView18.setImageResource(R.drawable.ic_valor);
            imageView19.setImageResource(R.drawable.ic_inspiracion);
            imageView20.setImageResource(R.drawable.ic_domination_round);
            imageView21.setImageResource(R.drawable.ic_brujeria);
            imageView22.setImageResource(R.drawable.ic_valor);
            imageView23.setImageResource(R.drawable.ic_inspiracion);
        ...
        if (champId == 6)
        {
            ...
            imageView34.setImageResource(R.drawable.ic_concentracion_absoluta_round);
        ...
        if (champId == 7)
        {
            ...
            imageView3.setImageResource(R.drawable.ic_segador_esencia);
